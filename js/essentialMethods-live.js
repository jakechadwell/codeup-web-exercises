...
//TODO: Let's make an object for us to use with .css(). .
    var warningRed = {'background-color': 'red', 'font-size': '72 px'}
...
$('store').removeClass('bg-dark', 'navbar-dark');
//TODO: Add the class of navbar-light and bg-info from the <nav> with jQuery.
$('store').addClass('navbar-light', 'bg-info');
...
$("#colorschemeBtn").click(function(){
    $("store").toggleClass("navbar-dark, bg-dark")
})
